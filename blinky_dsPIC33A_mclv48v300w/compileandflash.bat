...
set PROJECT_ROOT= C:\_GIT\Masters25\blinky_dsPIC33A_mclv48v300w\project\blinky_dspic33a_mclv48v300w.X
set MPLABX_ROOT=C:\Program Files\Microchip\MPLABX\v6.25
set DEVICE=33A128MC106
set TOOL=PKOB4
set HEXFILE=\dist\default\production\blinky_dspic33a_mclv48v300w.X.production.hex
